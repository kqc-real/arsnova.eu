...
> **Verifizierung Epic 1 (2026-03-09, ergänzt 2026-04-01, 2026-04-07, 2026-04-17, 2026-05-16):** Die umgesetzten Kern-Stories in Epic 1 sind auf **✅ Fertig** gesetzt — siehe Übersichtstabelle. **Offen** bleiben aktuell **1.2d**, **1.2ec–1.2ed**, **1.2f–1.2i**, **1.6c**, **1.6d**, **1.14a** (dort ⬜). **Story 1.2e**, **Story 1.2ea**, **Story 1.2eb**, **Story 1.7a** und **Story 1.7b** sind umgesetzt und auf **✅ Fertig** gesetzt.
...
- **Story 2.9 (Asynchrone Quiz-Modi und Feedback-Strategien):** 🔴 Als Lehrperson möchte ich beim Start einer Quiz-Instanz festlegen können, ob das Quiz **host-gesteuert synchron** oder **teilnehmendenindividuell asynchron** läuft und wann Rückmeldungen sichtbar werden, damit dieselben Quiz-Inhalte sowohl im Plenum als auch im eigenen Tempo bearbeitet werden können.
  ...
  - **Akzeptanzkriterien:**
    ...
    - **Kompatibilität mit Modi:** Anonymer Modus, freie Nicknames, Team-Modus, Presets, Lesephase, Kurzantwort, Rating, Survey, Freitext und zukünftige Schätzfragen werden explizit behandelt. Nicht unterstützte Kombinationen müssen im Startdialog verständlich deaktiviert oder erklärt werden, statt zur Laufzeit zu brechen.
