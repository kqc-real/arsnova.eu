...
- **Story 1.14c (Word Cloud 3.0 – semantischer Q&A-Themenmodus mit eigenem Open-Weight-Inferenzserver):** 🟡 Als Lehrperson möchte ich in der Host-Q&A-Wortwolke zusätzlich zu Einzelwörtern und Begriffen/Phrasen einen erklärbaren semantischen Themenmodus aufrufen, damit sinngleiche Fragen und Paraphrasen als gemeinsame Themen sichtbar werden, ohne den Q&A-Livebetrieb von KI-Inferenz abhängig zu machen.
  ...
  - **Abhängigkeiten und kanonische Quellen:** Story 0.7, Story 1.14/1.14a/1.14b, Story 4.5, Story 6.5, Story 8.6/8.7/8.9a–d, ADR-0012, ADR-0013, ADR-0025, ADR-0026, ADR-0032, ADR-0035, [`WORD-CLOUD-3.0-STORY-VORSCHLAG.md`](docs/implementation/WORD-CLOUD-3.0-STORY-VORSCHLAG.md), [`PRAKTIKUM-DATA-ANALYTICS.md`](docs/praktikum/PRAKTIKUM-DATA-ANALYTICS.md), [`CLOUD-COMPUTING-KURSREADME.md`](docs/didaktik/CLOUD-COMPUTING-KURSREADME.md), [`CLOUD-COMPUTING-AGENTIC-LEHRLABOR.md`](docs/didaktik/CLOUD-COMPUTING-AGENTIC-LEHRLABOR.md) und [`vorlesungen-cloud-computing-termine.md`](docs/didaktik/vorlesungen-cloud-computing-termine.md).
