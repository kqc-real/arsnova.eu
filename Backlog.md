...
>
> **Nächster Fokus (Auswahl offener Stories):** u. a. **2.9** (asynchrone Quiz-Modi, noch nicht beauftragt), **1.2ec–1.2ed** (Kurzantwort-Ausbau), **8.5** (delegierbare Q&A-Moderation), **8.9a–8.9c** (didaktischer Live-Moderationskompass) — **Epic 6** ist einschließlich der formalen WCAG-2.2-AA-Abnahme von **6.5** und der abgeschlossenen UX-Testreihen **6.6** umgesetzt ✅. **Lehre:** Greenfield-Demo **1.7a** in **3×45 Min.** — [`docs/didaktik/greenfield-demo-1-7a-vorlesung.md`](docs/didaktik/greenfield-demo-1-7a-vorlesung.md).
>
...
- **Story 1.14b (Word Cloud 2.6 – optionale spaCy-Glättung auf dem Single Host):** 🟡 Als Lehrperson möchte ich in der Freitext- und Q&A-Wortwolke auf Wunsch unterschiedliche Sprachformen zu stabilen, lesbaren Begriffen zusammenführen, damit Flexionen die inhaltliche Verdichtung nicht künstlich aufsplitten und die bestehende lexikalische Wortwolke vollständig erklärbar bleibt.
  ...
  - **Akzeptanzkriterien – linguistische Qualität:**
    ...
    - Gruppiert werden zunächst `NOUN`, `PROPN` und geschützte technische Begriffe. Eigennamen werden nicht blind lemmatisiert, deutsche Komposita nicht aggressiv zerlegt und Mehrwortbegriffe nicht unkontrolliert expandiert.
...
- **Story 1.14c (Word Cloud 3.0 – semantischer Q&A-Themenmodus mit eigenem Open-Weight-Inferenzserver):** 🟡 Als Lehrperson möchte ich in der Host-Q&A-Wortwolke zusätzlich zu Einzelwörtern und Begriffen/Phrasen einen erklärbaren semantischen Themenmodus aufrufen, damit sinngleiche Fragen und Paraphrasen als gemeinsame Themen sichtbar werden, ohne den Q&A-Livebetrieb von KI-Inferenz abhängig zu machen.
  ...
  - **Bezug zu 8.9b/8.9c:** Story 1.14c besitzt die semantische Q&A-Clusterpipeline und den selbstgehosteten Inferenzserver. Story 8.9b darf deren geprüfte Themen-/Konfidenzsignale im Moderationskompass wiederverwenden; Story 8.9c darf denselben Server für eine getrennte quellengebundene Moderationszusammenfassung nutzen. Beide Stories dürfen keine zweite konkurrierende Wortwolken-Infrastruktur aufbauen.
...
- **Story 8.9b (Optionale Q&A-NLP-Kaskade für Moderationssignale):** 🟡 Als Lehrperson oder Moderator:in möchte ich optional asynchron berechnete Q&A-Kategorien und Unsicherheitswerte im Moderationskompass sehen, damit Themenballungen schneller sichtbar werden, ohne dass das Einreichen oder Anzeigen von Q&A-Fragen von Inferenz abhängt.
  ...
  - **Abgrenzung zu Story 1.14c:** Der semantische Q&A-Themenmodus, seine Clusterpipeline und der eigene Open-Weight-Inferenzserver werden zentral in Story 1.14c spezifiziert. Story 8.9b konsumiert bei Verfügbarkeit nur deren geprüfte Themen- und Konfidenzsignale für den Moderationskompass und baut keinen parallelen NLP-/Modellserver auf.
  - **Akzeptanzkriterien:**
