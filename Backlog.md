...
- **Story 1.14b (Word Cloud 2.6 – optionale spaCy-Glättung auf dem Single Host):** 🟡 Als Lehrperson möchte ich in der Freitext- und Q&A-Wortwolke auf Wunsch unterschiedliche Sprachformen zu stabilen, lesbaren Begriffen zusammenführen, damit Flexionen die inhaltliche Verdichtung nicht künstlich aufsplitten und die bestehende lexikalische Wortwolke vollständig erklärbar bleibt.
  ...
  - **Akzeptanzkriterien – linguistische Qualität:**
    ...
    - Die erste produktive Modellstufe ist auf `de` und `en` begrenzt. `fr`, `es` und `it` fallen kontrolliert auf die bestehende lexikalische Analyse zurück, bis Modelle und Qualitätsfixtures ausdrücklich freigegeben sind.
  ...
  - **Technisches Zielbild – bestehender Single Host:**
    - spaCy läuft als optionaler, ausschließlich intern erreichbarer Sidecar hinter dem Backend auf der bestehenden One-Server-Infrastruktur; es wird weder in das Angular-Frontend noch als Python-Laufzeit in den Node-App-Container eingebaut.
  ...
  - **Tests und Verifikation:**
    ...
    - Vor Produktivfreigabe sind Single-Host-Ressourcenbudget, Containerlimits, Fallback und Deaktivierung auf einer isolierten Zielumgebung nachgewiesen.
  - **Nicht-Ziele:** semantische Paraphrasencluster, Embeddings, generative Labels, Teilnehmeranalyse, Sentimentanalyse, automatische Dauerneuberechnung, neue Layout-Engine oder externer SaaS-NLP-Dienst.
