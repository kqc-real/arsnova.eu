...
- **Story 0.7 (Last- & Performance-Tests mit E2E-Szenarien):** 🟡 Als Entwickler möchte ich reproduzierbare Last- und Performance-Tests mit realitätsnahen E2E-Szenarien haben, damit Engpässe in Live-Sessions, Join-Flows, Freitext, Q&A und Synchronisierung früh erkannt und vor Releases messbar bewertet werden können.
  ...
  - **Aktueller Implementierungsstand (2026-07-05, abgeglichen mit [ADR-0013](docs/architecture/decisions/0013-use-k6-and-artillery-for-load-and-performance-testing.md)):**
    ...
    - **Dokumentation & Ergebnisse:** [`docs/TESTING.md`](docs/TESTING.md) (Last-Smokes), [`docs/implementation/LASTTEST-500-TEILNEHMENDE.md`](docs/implementation/LASTTEST-500-TEILNEHMENDE.md), [`docs/implementation/LASTTEST-ARSNOVA-ARCHITEKTUR-ARBEITSAUFTRAG.md`](docs/implementation/LASTTEST-ARSNOVA-ARCHITEKTUR-ARBEITSAUFTRAG.md), Ergebnisberichte vom 2026-05-09 (lokal + Produktions-Join); Praktikums-Einstieg: [`docs/praktikum/HANDOUT-LAST-UND-PERFORMANCE-TESTS.md`](docs/praktikum/HANDOUT-LAST-UND-PERFORMANCE-TESTS.md).
    - **Teilweise abgedeckt:** Join-Welle, aktive Frage, Vote-Spike, Status-Fan-out (WS), Host-Vote-Fortschritt, Timer-Fairness unter Last.
    - **Offen für volle Story-Erfüllung:** Artillery-Szenarien (Realtime/E2E-nahe Last), PR-/CI-Smoke, maschinenlesbare Ergebniszusammenfassungen, Laufvergleich, Lastszenarien für Freitext, Q&A, Reconnect und Sync; produktionsnaher Voll-Lauf (Vote/Status auf Zielsystem) noch nicht abgeschlossen.
