...
- **Story 1.6c (Sync-Sicherheit härten):** 🔴 🗓️ **Technisch fertig – automatischer Cutover am 1. Oktober 2026.** Als Lehrperson möchte ich, dass geteilte Quiz-Sammlungen sicherer geöffnet werden können, damit ein versehentlich weitergegebener oder missverstandener Sync-Zugang nicht stillschweigend Vollzugriff gewährt.
  - **Stand 2026-08-07:** UI-Kommunikation, Relay-Caps, Rate-/Payload-/Verbindungsgrenzen, signierte langlebige Share-Tokens, serverseitig erzeugte sichere Räume, Generationen und manuelle Link-Rotation sind umgesetzt. Es gibt kein weiteres Implementierungsticket. Die UUID-only-Legacy-Grace endet automatisch über `YJS_SHARE_LEGACY_UUID_CUTOFF_AT` (Default `2026-10-01T00:00:00Z`); danach ist nur noch die reguläre betriebliche Beobachtung vorgesehen.
  - **Akzeptanzkriterien:**
