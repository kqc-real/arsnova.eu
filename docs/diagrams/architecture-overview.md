...
graph LR
    subgraph "Monorepo (npm Workspaces)"
        subgraph "Frontend - Angular 21.2.x"
            ...
            FE_ROUTES["Routing<br/>/quiz<br/>/session/:code/(host|present|vote)<br/>/join/:code · /host-recovery<br/>/feedback/:code · /feedback/:code/vote<br/>/admin · /help · /news-archive · /legal/*<br/>optional locale prefix:<br/>/de /en /fr /es /it"]
...
Vereinfachte Sicht. Details und Kill-Switches: [diagrams.md §1.3](diagrams.md), [moderation-compass.md](../features/moderation-compass.md). Live-Submit wartet nicht auf Inferenz. 1.14c Stufe 1 ist der optionale Encoder-Sidecar; Stufe 2 bleibt Zielbild.
...
flowchart LR
    ...
    ENC[Encoder-Sidecar 1.14c Stufe 1]
    NLP[QA-NLP-Queue optional]
    SUM[Summary-Adapter optional]
    LLM[LLM Stufe 2 / Slice 4 offen]

    HOST --> LEX
    HOST -.->|Sprachformen glaetten| SPACY
    HOST -.->|Q-and-A Themen| ENC
