...
| [QA-Word-Cloud-Host-Kontext.png](./QA-Word-Cloud-Host-Kontext.png)                                               | Kontextansicht  | Q&A-Wortwolke in der Host-Ansicht                                   | Zeigt, wie Hosts die gewichtete Q&A-Wortwolke mit Sortiermodi, Antwortliste, Exporten und Moderationskontext als Analysewerkzeug nutzen koennen.         |
