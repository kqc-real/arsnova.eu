...
- Fragetypen: Single-/Multiple-Choice, Freitext, Kurzantwort, Umfrage, Rating, numerische Schätzfrage, Zuordnung, Reihenfolge und Kategorisierung.
...
- Offene Punkte: Editor-Toolbar-Ausbau, Word-Cloud-2.0 und Schlüsselwort-/Token-Bewertung für den `SHORT_TEXT`-Ausbau (1.2ec/1.2ed). **1.2f** (Hotspot) ist aus A11y-Gründen geschlossen; **1.2g–1.2h**, **1.2i** und **1.2j** sind fertig. Die Sync-Härtung ist technisch umgesetzt; der UUID-only-Legacy-Zugriff endet automatisch am **1. Oktober 2026**. Weitere Sync-Performance-Optimierungen sind ohne nachgewiesenen Engpass nicht geplant.
...
- Offen: delegierbare Moderation (8.5) sowie das echte LLM für die Moderationszusammenfassung (8.9c Slice 4). 8.9a (Host-UX), 8.9b (optionale NLP-Kaskade, Kill-Switch default aus) und 8.9c Slices 1–3 (Vertrag, Host-Button, privater Adapter, Kill-Switch default aus) sind umgesetzt.
