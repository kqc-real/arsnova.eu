...
| 6   | **1.2g–1.2h, 1.2j** | Zuordnung, Reihenfolge, Gruppierung          | Weitere Fragetypen                        | **Varianten nach dem ersten Fragentyp:** dieselben Muster wiederholen und bewusst abstrahieren, ohne Schema- und UI-Regeln zu verwässern. **1.2f** (Hotspot) ist aus A11y-Gründen geschlossen; **1.2i** (Confidence) ist fertig. |
