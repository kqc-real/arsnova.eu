...
**Backlog-Bezug:** Maßgeblich ist der aktuelle Stand in [`Backlog.md`](../../Backlog.md); dieses Dokument dupliziert bewusst keine Story-Zahlen mehr, damit die Referatsthemen bei Backlog-Änderungen nicht veralten. Bei größeren Änderungen bitte Beispiele, Begriffe und Nachweise neu prüfen.
