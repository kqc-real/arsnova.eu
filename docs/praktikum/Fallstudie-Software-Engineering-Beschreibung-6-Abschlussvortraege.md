...
**Aktuelle Repo-Anker für Beispiele:** Je nach Schwerpunkt lassen sich die Vorträge gut mit den derzeitigen offenen oder laufenden Themen verknüpfen, zum Beispiel **0.7** (Last- & Performance-Tests), **1.2ec–1.2ed** (Short Answer / gemeinsame Bewertungsbasis), **2.10** (Paired Host für vertrauenswürdige Co-Hosts), **6.5–6.6** (Barrierefreiheit / UX-Testreihen) oder **8.9a–8.9c** (didaktischer Live-Kompass). Für ein abgeschlossenes, gut dokumentiertes Gegenbeispiel eignet sich weiterhin **Epic 10 / MOTD**.
