...
| `RATE_LIMIT_ADMIN_LOGIN_GLOBAL_FAILURES_PER_WINDOW`    | nein         | `60`                       | Globales Fehlversuchslimit für `admin.login`; gültige Zugangsdaten werden nicht blockiert, kein IP-Lockout                                                          |
