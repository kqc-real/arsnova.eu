...
| `YJS_SHARE_LEGACY_UUID_CUTOFF_AT`                      | nein         | `2026-10-01T00:00:00.000Z`    | ISO-Zeitpunkt: danach lehnt der Yjs-Relay UUID-only-Upgrades ohne gültiges Share-Token (`?s=`) ab                                                                      |
| `RATE_LIMIT_YJS_SHARE_REGISTER_PER_IP_PER_HOUR`        | nein         | `30`                          | Max. Share-Registrierungen pro Client-IP und Stunde                                                                                                                    |
| `RATE_LIMIT_YJS_SHARE_REGISTER_GLOBAL_PER_HOUR`        | nein         | `200`                         | Globales Budget Share-Registrierungen pro Stunde                                                                                                                       |
