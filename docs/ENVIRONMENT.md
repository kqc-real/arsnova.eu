...
| `TRPC_WS_MAX_CONNECTIONS_PER_SESSION`                  | nein         | `1000`                     | Cap je gültigem Session-Code-Throttle-Signal; volle Reserve für eine stale 500er-Reconnect-Kohorte, Code-Minimum `750`, Maximum `5000`, kein Authentifizierungsbeweis |
...
Gültige, normalisierte Session-Codes begrenzen standardmäßig auf 1.000
Verbindungen und lassen damit neben 500 aktiven Sockets eine vollständige
500er-Ersatzkohorte für noch nicht erkannte stale Verbindungen zu; ein
