...
| `YJS_SHARE_LEGACY_UUID_CUTOFF_AT`                      | nein         | `2026-10-01T00:00:00.000Z`    | ISO-Zeitpunkt: danach lehnt der Yjs-Relay UUID-only-Upgrades ohne gültiges Share-Token (`?s=`) ab; ein gesetzter ungültiger Wert bricht den Start ab                   |
