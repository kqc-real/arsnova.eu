...
| `QA_NLP_ENABLED`                                       | nein         | `false`                       | Kill-Switch für die optionale Q&A-NLP-Kaskade (Story 8.9b, Gatekeeper plus k-NN-Fallback). Nur exakt `true` aktiviert den Pfad. Getrennt von `NLP_ENABLED` (spaCy 1.14b). Produktiv default aus; Hörsaallast vor Aktivierung. Produktdoku: [qa-nlp-moderation.md](features/qa-nlp-moderation.md)                                                                        |
