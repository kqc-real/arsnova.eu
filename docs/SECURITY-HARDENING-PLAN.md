...
| W2.4 | **W2.4a umgesetzt:** sicherer Report-Ingest mit **Rate-Limit**, Payload-**Minimierung**, definierter **Retention**. **W2.4b offen:** CSP-Report-Only-Policy erst nach Deployment/Smoke aktivieren; `unsafe-eval`/`https:` in script-src beobachten             | Reports sammeln unter RL; keine PII-Lawine; App ungebrochen                        |
