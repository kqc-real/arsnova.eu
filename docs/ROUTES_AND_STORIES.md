...
Jede Zeile = eine Route; Spalte „Stories“ = alle Backlog-Story-IDs, die diese Route betreffen (inkl. Sub-Stories wie 1.2a, 1.2ea, 2.1b, 3.5a, …).
...
| **`/quiz/:id`**              | Host          | **1.2a** (MC/SC), **1.2b** (Freitext, Umfrage), **1.2c** (Rating), **1.2d** (numerische Schätzfrage: Referenzwert, Toleranz-/Plausibilitätsband, zwei Runden), **1.2e** (Kurzantwort / Short Answer), **1.2ea** (Textbewertung 2.0), **1.2eb** (Numerik-Basis), **1.2ec** (Schlüsselwort-Basis), **1.2ed** (Token-Basis), **1.2f** (Hotspot), **1.2g** (Zuordnung / Matching), **1.2h** (Reihenfolge / Sortieren), **1.2i** (Confidence Slider), **1.2j** (Gruppierung / Kategorisierung), **1.3** (Antworten & Lösungen), **1.4** (Sitzungs-Konfiguration), **1.7** (Markdown & KaTeX), **1.10** (Bearbeiten), **1.11** (Presets, Optionen), **1.12** (SC-Schnellformate), **1.6a** („Auf anderem Gerät öffnen“, Sync-Link/Code), **6.4**, **6.5** |
...
| 0.7        | Last- & Performance-Tests                                                                      | Backend, Load-Skripte, Smoke-Flows     |
| 0.8        | Komplexitätsabbau / McCabe-Refactor                                                            | Backend, Frontend, Shared Code         |
| 1.5        | Local-First Speicherung                                                                        | Quiz-Editor, IndexedDB/Yjs             |
| 1.6        | Yjs Multi-Device-Sync                                                                          | Backend + Quiz-Editor/Sync-Route       |
| 1.2ec–1.2i | Neue Fragentyp-Bausteine / Kurzantwort-Erweiterungen                                           | Quiz-Editor, shared-types, Backend     |
| 1.14a      | Word Cloud 2.0                                                                                 | Frontend, Word-Cloud-UX                |
| 2.4        | Security / Data-Stripping                                                                      | Backend DTOs                           |
| 2.9        | Asynchrone Quiz-Modi                                                                           | Backend + Session-Flow                 |
...
| 8.9a–8.9c  | Didaktischer Live-Moderationskompass, optionale Q&A-NLP-Kaskade und generative Zusammenfassung | Backend + Host-UI                      |
