...
| Aspekt                       | Stand                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Extrahierte Messages**     | 1691 trans-units in `messages.xlf` und den Locale-Dateien (Stand nach aktuellem Extract / Repo-Abgleich)                                                                                                                                                                                                                                                                                                                                    |
...
_Stand: 2026-05-31. Repo-Abgleich mit Angular 21.2.x, fünf Locale-Dateien mit je 1691 trans-units und Dokumentation unter https://angular.dev/guide/i18n._
