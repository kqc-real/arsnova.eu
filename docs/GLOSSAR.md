...
- **Wortwolke / Word Cloud:** Live-Visualisierung häufiger Begriffe aus Freitext-Antworten und Q&A-Fragen; lexikalisch mit optionaler Sprachformen-Glättung. Themenmodus: Host-Toggle **Themen** in Q&A (Story 1.14c Stufe 1, Encoder default aus) und Freitext (Toggle mit 2.x-Fallback). Presenter bleibt auf dem lexikalischen Pfad. Vorkommen: Host, Presenter. Vertiefung: ADR-0012, Story 1.14 / 1.14a / 1.14b / 1.14c, [word-cloud-spacy](features/word-cloud-spacy.md), [word-cloud-semantic](features/word-cloud-semantic.md).
