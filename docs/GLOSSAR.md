...
| **NLP**    | Natural Language Processing              | Getrennte optionale Pfade: Wortwolken-Glättung (1.14b, `NLP_ENABLED`), Q&A-Kategorien (8.9b, `QA_NLP_ENABLED`), semantische Themen (1.14c Stufe 1, `WORD_CLOUD_SEMANTIC_ENABLED`) |
