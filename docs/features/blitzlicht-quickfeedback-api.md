...
- **Create-Limits:** Standalone-Create nutzt großzügige kombinierte Global-/Shared-NAT-Budgets. Session-Create wird nach erfolgreicher Host-Prüfung pro Session begrenzt (120/Minute im Standardprofil), niemals eng pro Hörsaal-IP.
