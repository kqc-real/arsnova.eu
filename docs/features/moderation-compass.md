...
Quellen sind Sprungzeilen mit Ziel (**Q&A**, **Wortwolke**, **Quiz**, **Blitzlicht**). Pro Karte sind drei Quellen sichtbar; weitere stehen hinter einem Aufklapp-Label. Bei gemischten Quellen lautet es **Weitere Einstiege (N)**; bei weiteren Wortwolken-Termen **Weitere Wortwolken-Themen**; nur bei Sortierung **BEST**, aktiver Glättung und Einzelwort-Modus (keine Phrasen) **Top-Themen der Wortwolke**. Bei Wortwolken-Einträgen steht zuerst der Begriff, danach ein Beispiel aus einer zugehörigen Frage (kein NLP-Thema). NLP-Kategorien (Inhalt/Ablauf/Technik) erscheinen separat als Q&A-Quellen. Quellenklicks wechseln den Kanal, heben Forum-Beiträge hervor (Badge **Aus dem Kompass · …**) oder öffnen die Wortwolke zum Begriff. **Zurück zum Kompass** stellt den vorherigen Kanal wieder her und öffnet den Dialog erneut. **Markierung lösen** entfernt die Hervorhebung.
