...
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- | ------------------------------------------------- |
| **Quiz**                                          | Wie Blitzlicht: vorhandene Host-Session öffnen (`?tab=quiz`), sonst `session.create` ohne `quizId`. Host öffnet die Quizauswahl, wenn der Quizkanal noch fehlt oder nach FINISHED ein Folgeqiz möglich ist. Kurzbeschreibung **Quiz wählen**. Eigenes letztes Quiz: Filled-CTA **Letztes Quiz starten** auf derselben Live-Karte (`?startLiveQuiz=`), nicht auf Vorbereiten. Sammlung bleibt über die Vorbereiten-Karte. | Code+Test | `openHeroHostTab('quiz')`, `home-live-last-quiz`  |
