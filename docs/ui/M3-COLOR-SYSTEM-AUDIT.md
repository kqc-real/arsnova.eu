...
| **Primäre Akzente**                   | Primary + Tertiary in `mat.theme()` (Seriös: Azure/Cyan, Spielerisch: Magenta/Orange). Secondary wird von Angular Material aus Primary abgeleitet.                                                                                                                                                                                                 |
...
| **Inverse für Snackbars**             | Seriös: inverse-surface, inverse-on-surface, inverse-primary für Preset-, Install- und Material-Snackbar (M3-Default). Spielerisch: bewusst Surface-Chrome (Primary-/Tertiary-Verlauf, Tertiary-Aktion) statt invers-weiß, analog Toolbar/Startseite. Dieselbe Surface-Regel gilt für Tooltip, Menü, Select, Autocomplete und Material-Datepicker. |
...
| **Statisches Baseline-Schema**        | Kein Dynamic Color; hand-picked Paletten (Azure/Cyan, Magenta/Orange). M3: „Baseline static scheme“ ist vorgesehen, Wechsel zu Dynamic Color später möglich.                                                                                                                                                                                       |
