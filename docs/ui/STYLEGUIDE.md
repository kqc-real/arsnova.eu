...
- Preset **Spielerisch:** `html.preset-playful` überschreibt die Palette mit `mat.$magenta-palette` und `mat.$orange-palette` und setzt zusätzliche app-spezifische Surface-/Shadow-Tokens.
