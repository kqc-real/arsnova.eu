...
- **Abstaende:** Interne Aktionsraster verwenden regulaer 0,5–0,6 rem Abstand; die Desktop-Vierergruppe fuer direktes Feedback nutzt 0,75 rem. Card-Header, Inhalt und Actions behalten 1 rem Inline-Padding. Im breiten Desktop-Raster erhalten alle Home-Karten 1,25 rem Abstand zum unteren Kartenrand.
