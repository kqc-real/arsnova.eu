...
- **News-Archiv gelesen:** **Ungelesen** und **Gelesen** sind Status (Punkt bzw. Häkchen), keine Schaltflächen. Sie stehen im Dialog **außerhalb** des Expansion-Headers, damit ein Klick weder markiert noch das Panel umklappt. Die Aktion heißt **Als gelesen markieren** (`matButton="text"`, kein CTA) und liegt in derselben Fußzeile.
