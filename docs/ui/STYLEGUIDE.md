...
- **News-Archiv gelesen:** **Ungelesen** und **Gelesen** sind Status (Punkt bzw. Häkchen), keine Schaltflächen. Die Aktion heißt **Als gelesen markieren** (`matButton="text"`, kein CTA) und liegt im Dialog **außerhalb** des Expansion-Headers, damit sie ohne Aufklappen erreichbar ist. Ein Klick auf den Status ändert nichts.
