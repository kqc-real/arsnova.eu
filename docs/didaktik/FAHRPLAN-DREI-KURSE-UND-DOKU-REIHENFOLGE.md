...
**Kurz:** In **FSE** sind **Woche 1–3** die **Greenfield-Demo Story 1.7a** (3×45 Min., KI-Agent) plus Tool-Mini-Vorlesungen; ab **Woche 4** Schwerpunkt **gestützte Story-Arbeit** entlang der aktuellen offenen Ticketstrecke oder eines bewusst gekürzten Lehrzuschnitts ([`STUDENT-STORY-REIHENFOLGE.md`](../praktikum/STUDENT-STORY-REIHENFOLGE.md)). **SQM** startet **meta** (Rolle, DoD, CI), geht **Woche 4+** in konkrete **Reviews** und später **Tests/Sicherheit/UX**. **DA** bleibt **konzept- und evidenzlastig**, technische Repo-Tiefe nur soweit nötig für Abstimmung mit FSE.
