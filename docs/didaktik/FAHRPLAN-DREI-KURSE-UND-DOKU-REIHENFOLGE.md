...
10. **[`AGENTS.md`](../../AGENTS.md)** — vor der **ersten** studentischen Story mit KI-Unterstützung.
...
- [ ] Vor erster Story: **AGENTS.md** + **CONTRIBUTING** genannt.
