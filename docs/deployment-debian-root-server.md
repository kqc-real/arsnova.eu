...
server {
    ...
    location / {
        ...
        # Externe XFF-Werte nicht weiterreichen; Backend vertraut genau diesem Proxy-Hop.
...
- Gültige `connectionParams` binden als reines Throttle-Signal zusätzlich an
  Session (Standard 1.000 mit vollständiger 500er-Reconnect-Reserve) und
...
TRPC_WS_MAX_CONNECTIONS_PER_SESSION=1000
