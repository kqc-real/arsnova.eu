...
| Q&A-Moderation        | Delegierte Q&A-Moderation (**8.5**) bleibt offen; Moderationskompass (**8.9a**) fertig; **8.9b** fertig (Kill-Switch default aus); **8.9c** Slices 1–3 im Repo, Slice 4 (Modell) offen | Epic 8, ADR-0011, ADR-0032 |
...
| Sync & Word Cloud     | **1.6c** Cutover 1. Oktober 2026; **1.14c** Stufe 1 Encoder im Repo (Kill-Switch default aus), Stufe 2 LLM-Labels offen (**1.14a/1.14b** fertig; **0.8**/**1.6d** geschlossen)         | Backlog                    |
