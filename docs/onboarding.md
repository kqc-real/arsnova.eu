...
| Q&A-Moderation        | Delegierte Q&A-Moderation (**8.5**) bleibt offen; Moderationskompass (**8.9a**) fertig; **8.9b** fertig (Kill-Switch default aus), **8.9c** offen | Epic 8, ADR-0011, ADR-0032 |
