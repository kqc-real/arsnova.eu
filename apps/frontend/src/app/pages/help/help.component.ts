    ...
    <div class="help-page l-page">
      ...
      <article class="help-article">
        ...
        <section class="help-section">
          ...
          <p>arsnova.click ist kostenlos, Open Source und DSGVO-orientiert. Quiz-Inhalte werden lokal im Browser gespeichert (Local-First); Session-Daten werden nach Ende bereinigt. Keine Anmeldung nötig.</p>
        </section>
      </article>
    </div>
  `,
