...
describe('SessionVoteComponent', { timeout: 30_000 }, () => {
  ...
  beforeEach(() => {
    ...
    localStorage.removeItem('arsnova-participant-capability-ABC123');
    ...
    joinMutateMock.mockResolvedValue({
      ...
      participantNickname: 'Roter Drache 1',
    });
  ...
  it('stellt vor dem Absenden eine gültige Teilnahme her, statt eine leere participantId zu senden', async () => {
    localStorage.setItem('arsnova-participant-ABC123', 'kein-uuid');
    joinMutateMock.mockResolvedValue({
      id: '6a8edced-5f8f-4cfa-9176-454fac9570ad',
      participantId: '22222222-2222-4222-8222-222222222222',
      participantNickname: 'Grüner Frosch',
      rejoinToken: 'participant-capability-abcdefghijklmnopqrstuvwxyz',
    });
    const fixture = TestBed.createComponent(SessionVoteComponent);
    const component = fixture.componentInstance;
    component.sessionId.set('6a8edced-5f8f-4cfa-9176-454fac9570ad');
    component.participantId.set('');
    component.status.set('ACTIVE');
    component.currentRound.set(1);
    component.selectedAnswerIds.set(new Set(['a1']));
    component.currentQuestion.set({
    ...
    expect(component.voteError()).toBeNull();
    fixture.destroy();
  });
  ...
  it('zeigt Pole-Labels in der Selbsteinschätzungs-Zusammenfassung nur bei 1 und 5', async () => {
    getInfoQueryMock.mockResolvedValue({
      id: '6a8edced-5f8f-4cfa-9176-454fac9570ad',
      serverTime: MOCK_SERVER_TIME,
      code: 'ABC123',
    ...
    currentQuestionQueryMock.mockResolvedValue({
      id: 'confidence-summary-question',
      text: 'Frage?',
      type: 'SINGLE_CHOICE',
      difficulty: 'MEDIUM',
      order: 0,
    ...
    component.toggleAnswer('a1');
    fixture.detectChanges();
    component.selectConfidence(1);
    expect(component.confidenceResultSummary()).toBe('1 – Geraten');

    component.selectConfidence(2);
    expect(component.confidenceResultSummary()).toBe('2');

    component.selectConfidence(3);
    expect(component.confidenceResultSummary()).toBe('3');

    component.selectConfidence(4);
    expect(component.confidenceResultSummary()).toBe('4');

    component.selectConfidence(5);
    expect(component.confidenceResultSummary()).toBe('5 – Sehr sicher');
  ...
  it('merkt sich nach einer gestarteten Frage den Quizstart aus dem Live-Status', () => {
    type StatusPayload = {
      status: string;
    ...
    const fixture = TestBed.createComponent(SessionVoteComponent);
    const component = fixture.componentInstance;
    component.sessionSettings.set({ quizStarted: false });
    (
      component as unknown as {
    ...
    expect(component.sessionFeedbackAvailable()).toBe(true);
    fixture.destroy();
  });
  ...
  it('stellt die gespeicherte persönliche Zeit wieder her, wenn das Quiz sie wieder erlaubt', async () => {
    localStorage.setItem('arsnova-timer-accommodation', 'EXTENDED');
    type StatusPayload = {
      status: string;
      currentQuestion: number | null;
      currentRound?: number;
    ...
    for (
      let attempt = 0;
      attempt < 10 && setTimerAccommodationMutateMock.mock.calls.length === 0;
      attempt += 1
    ) {
      await flushComponentAfterStable(fixture, 50);
    }
  ...
  it('zeigt die Teamzugehörigkeit an Q&A-Fragen', () => {
    const fixture = TestBed.createComponent(SessionVoteComponent);
    const component = fixture.componentInstance;
    component.status.set('ACTIVE');
    ...
    expect(component.qaQuestionAuthorTeamName(component.qaQuestions()[0]!)).toBe('Team 🍎');
  ...
  it('zeigt die Teamzugehörigkeit fremder Q&A-Fragen auch über das Leaderboard', () => {
    ...
    component.personalLeaderboard.set([
      {
        rank: 1,
        nickname: 'Green frog 1',
        totalScore: 0,
        correctCount: 0,
        totalQuestions: 0,
