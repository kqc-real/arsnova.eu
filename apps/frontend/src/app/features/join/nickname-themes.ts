...
> = {
  ...
  en: {
    ...
    KINDERGARTEN: [
      ...
      'Emerald green snake',
      'Topaz yellow lion',
      'Ultramarine blue swan',
      'Vanilla colored lamb',
      'Burgundy parrot',
      'Vermilion Rooster',
      'Aquamarine dolphin',
      'Amber colored bear',
      'Chrome yellow butterfly',
      'Turquoise dog',
      'Coral cat',
      'Sky blue giraffe',
      'Lime green zebra',
  ...
  fr: {
    ...
    KINDERGARTEN: [
      ...
      'Oiseau couleur prune',
      'Renard roux rubis',
      'Serpent vert émeraude',
      'Lion jaune topaze',
      'Cygne bleu outremer',
      'Agneau couleur vanille',
      'Perroquet de Bourgogne',
      'Coq vermillon',
      'Dauphin aigue-marine',
      'Ours de couleur ambre',
      'Papillon jaune chrome',
      'Chien turquoise',
      'Chat corail',
      'Girafe bleu ciel',
      'Zèbre vert citron',
  ...
  es: {
    ...
    KINDERGARTEN: [
      ...
      'Pájaro color ciruela',
      'Zorro rojo rubí',
      'Serpiente verde esmeralda',
      'León amarillo topacio',
      'Cisne azul ultramar',
  ...
  it: {
    ...
    KINDERGARTEN: [
      ...
      'Uccello color prugna',
      'Volpe rosso rubino',
      'Serpente verde smeraldo',
      'Leone giallo topazio',
      'Cigno blu oltremare',
      'Agnello color vaniglia',
      'Pappagallo della Borgogna',
      'Gallo Vermiglio',
      'Delfino acquamarina',
      'Orsetto color ambra',
      'Farfalla giallo cromo',
      'Cane turchese',
      'Gatto corallo',
      'Giraffa celeste',
      'Zebra verde lime',
