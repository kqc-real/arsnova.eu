...
- **Ciclo de vida de la sesión:** De forma predeterminada, las sesiones finalizan 24 horas después de su creación. Dentro del límite definido por el operador y del máximo técnico de 30 días, el anfitrión puede elegir una fecha límite absoluta anterior o posterior. Almacenamos la hora de creación, el final global de la sesión, cuando corresponda un cierre de Q&A separado y la hora de la primera participación completada. Este último marcador no contiene ningún apodo y se conserva hasta que se elimina el registro de la sesión para impedir que la fecha límite se reconfigure posteriormente sin advertencia. Alcanzar la fecha límite finaliza los accesos y los cambios, pero no borra físicamente los datos por sí solo; para ello se aplica la regla de limpieza siguiente.
- **Seguimiento y limpieza de datos:** Tras finalizar la sesión, los anfitriones autorizados solo pueden leer y exportar el contenido Q&A existente durante 14 días; los participantes no obtienen acceso posterior. A continuación se eliminan técnicamente el núcleo de la sesión y sus contenidos dependientes. Una **Retención Legal** estrictamente limitada por ley o finalidad puede retrasar esta eliminación técnica, pero nunca amplía el acceso del anfitrión ni de los participantes. Los comprobantes de bonificación y las valoraciones de la sesión se conservan por separado durante un máximo de 90 días, y los registros administrativos de auditoría minimizados durante un máximo de 365 días; sus referencias directas a la sesión y a los participantes se eliminan junto con el núcleo de la sesión. Las estadísticas agregadas (p. ej., recuentos totales de participantes) no contienen información de identificación personal.
- **Perfil de participación y modo anónimo:** Antes de la primera participación, el anfitrión elige para toda la sesión entre seudónimos predefinidos, apodos elegidos por los participantes o el modo anónimo. Después, la elección queda bloqueada. En el modo anónimo, las contribuciones no muestran ningún autor; aun así, pueden procesarse datos técnicos de sesión, seguridad y prevención de abusos, por lo que no constituye una anonimización completa.
- **Comentarios de producto (separados de la valoración de sesión y del feedback rápido):** Tras una sesión utilizada, podemos pedirle dos selecciones breves sobre la facilidad de uso y la utilidad de arsnova.eu; también puede enviar comentarios en cualquier momento mediante «Mejorar arsnova.eu». La participación es voluntaria y no requiere inicio de sesión ni dirección de correo electrónico. Guardamos respuestas estructuradas y, opcionalmente, un texto breve. Los comentarios posteriores a una sesión pueden incluir además la clase aproximada de su tamaño. El contexto In-App se limita al idioma, la versión de la app, el grupo de ruta sin parámetros, la fase de sesión, el canal activo, la clase de dispositivo, la familia y versión principal del navegador, la familia del sistema operativo, el estado en línea y un ID de error o solicitud existente. **No se transmiten** URL completas, códigos o ID de sesión, apodos, contenidos de quiz, preguntas, respuestas o Q&A, códigos de bonificación, contenido de Local Storage, portapapeles ni capturas de pantalla. La dirección IP puede aparecer técnicamente en registros y mecanismos de limitación temporales, pero no como atributo del comentario. Solo los administradores de la plataforma ven los avisos, no los anfitriones ni la vista de presentación; el texto nunca se publica automáticamente. Los datos estructurados se conservan durante un máximo aproximado de 13 meses y los textos libres durante un máximo de 90 días. Su navegador puede guardar localmente estados de espera y cola; los borradores no enviados permanecen allí como máximo 7 días, sin crear un perfil entre dispositivos. Un enlace público de solución solo aparece tras la aprobación de un administrador. Los administradores autorizados pueden generar un paquete Markdown de análisis con una instrucción fija; los textos opcionales solo se incluyen si lo eligen expresamente. Los administradores autorizados pueden borrar de forma definitiva los comentarios guardados antes de plazo, por completo o hasta una fecha elegida.
