...
- **Comentarios de producto (separados de la valoración de sesión y del feedback rápido):** Tras una sesión realmente utilizada podemos pedirle, con dos selecciones breves, qué tan fácil y útil fue arsnova.eu. Es voluntario, sin inicio de sesión ni correo. Guardamos respuestas estructuradas y, opcionalmente, un texto breve, más un contexto técnico grueso (idioma, versión de la app, clase de dispositivo, tamaño de sesión) — **sin** códigos de sesión, apodos ni contenidos de quiz/Q&A. Solo lo ven administradores de la plataforma, no anfitriones ni la vista presentador. Datos estructurados: como máximo ~13 meses; textos libres: como máximo 90 días. El navegador puede guardar estados locales de espera/cola (sin perfil entre dispositivos).
