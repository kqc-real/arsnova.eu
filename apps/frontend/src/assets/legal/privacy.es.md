...
- **Comentarios de producto (separados de la valoración de sesión y del feedback rápido):** Después de una sesión o en cualquier momento mediante «Mejorar arsnova.eu», puede enviar voluntariamente comentarios con dos selecciones breves, sin inicio de sesión ni correo. Guardamos respuestas estructuradas y, opcionalmente, un texto breve. El contexto In-App se limita a idioma, versión de la app, grupo de ruta sin parámetros, fase de sesión, canal activo, clase de dispositivo, familia y versión principal del navegador, familia del sistema, estado en línea y un ID de error/solicitud existente. **No se transmiten** URL completas, códigos/ID de sesión, apodos, contenidos de quiz, preguntas, respuestas o Q&A, códigos de bonificación, contenido de Local Storage, portapapeles ni capturas. La IP puede aparecer técnicamente en registros y límites temporales, pero no como atributo del comentario. Solo los administradores ven los avisos; el texto nunca se publica automáticamente. Conservación: datos estructurados hasta unos 13 meses, texto hasta 90 días y borradores locales no enviados hasta 7 días. Un enlace público de solución solo aparece tras la aprobación de un administrador.
