...
- **Produktfeedback (getrennt von Session-Bewertung und Blitzlicht):** Nach genutzten Sessions können wir dich optional bitten, mit zwei kurzen Auswahlen die Bedienbarkeit und den Nutzen von arsnova.eu zu bewerten. Das ist freiwillig, ohne Login und ohne E-Mail-Adresse. Gespeichert werden strukturierte Antworten sowie optional ein kurzer Freitext, dazu nur grober technischer Kontext (z. B. Sprache, App-Version, Geräteklasse, Sessiongröße) – **keine** Sessioncodes, Nicknames, Fragen, Antworten, Quiz- oder Q&A-Inhalte. Die Auswertung ist nur für Plattform-Admins sichtbar, nicht für Hosts und nicht auf dem Beamer. Strukturierte Daten werden höchstens ca. 13 Monate, optionale Freitexte höchstens 90 Tage aufbewahrt. Lokal kann dein Browser Cooldown-/Warteschlangenstände speichern (kein geräteübergreifendes Profil).
