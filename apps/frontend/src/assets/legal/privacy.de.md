...
- **Produktfeedback (getrennt von Session-Bewertung und Blitzlicht):** Nach genutzten Sessions oder jederzeit über „arsnova.eu verbessern“ können Sie freiwillig und ohne Login oder E-Mail-Adresse mit zwei kurzen Auswahlen Feedback geben. Gespeichert werden strukturierte Antworten sowie optional ein kurzer Freitext. Beim In-App-Feedback umfasst der grobe technische Kontext höchstens Sprache, App-Version, parameterlose Routengruppe, Sessionphase, aktiven Kanal, Geräteklasse, Browserfamilie mit Hauptversion, Betriebssystemfamilie, Onlinezustand und eine vorhandene Fehler-/Request-ID. **Nicht** übertragen werden vollständige URLs, Sessioncodes/-IDs, Nicknames, Quiz-, Frage-, Antwort- oder Q&A-Inhalte, Bonus-Codes, Local-Storage-Inhalte, Zwischenablage oder Screenshots. IP-Adressen können technisch in kurzfristigen Server-Logs und Rate-Limits anfallen, werden aber nicht als Feedbackattribut gespeichert. Nur Plattform-Admins sehen die Meldungen; Freitext wird nicht automatisch veröffentlicht. Strukturierte Daten werden höchstens ca. 13 Monate, Freitexte höchstens 90 Tage und lokale ungesendete Entwürfe höchstens 7 Tage aufbewahrt. Ein öffentlicher Lösungslink erscheint nur, wenn ein Admin ihn freigibt.
