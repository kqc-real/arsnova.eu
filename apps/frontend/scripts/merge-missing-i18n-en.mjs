...
const TARGET_MAP = {
  ...
  'quizEdit.livePreviewAnswersLabel': 'Answers',
  'quizPreview.editorAnswerOptionsHeading': 'Answer options',
  ...
  'quizForm.timerSecondsSuffix': 'seconds',
  ...
  'quizForm.defaultTimerLabel': 'Time limit per question',
