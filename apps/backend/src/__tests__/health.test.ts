...
describe('health.stats', () => {
  ...
  it('liefert Create-, 429- und aktuelle WebSocket-Metriken nur authentifiziert', async () => {
    ...
    vi.mocked(getWebSocketTelemetrySnapshot).mockReturnValue({
      ...
      trpcConnectionLimit: 1_000,
      trpcBoundConnectionsActive: 300,
      trpcSessionConnectionLimit: 800,
      trpcParticipantConnectionLimit: 2,
      trpcSessionCapRejectedLastMinute: 3,
      trpcParticipantCapRejectedLastMinute: 4,
    ...
    expect(result).toMatchObject({
      sessionCodeClientFailuresPerWindow: 5,
      sessionCreatesLastMinute: 12,
      adminLoginFailuresLastMinute: 15,
      ...
      trpcWebSocketBoundConnectionsActive: 300,
      trpcWebSocketSessionConnectionLimit: 800,
      trpcWebSocketParticipantConnectionLimit: 2,
      trpcWebSocketSessionCapRejectedLastMinute: 3,
      trpcWebSocketParticipantCapRejectedLastMinute: 4,
