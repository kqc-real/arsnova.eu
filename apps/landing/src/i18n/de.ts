...
const de: Messages = {
  ...
  qaWall: {
    ...
    terms: [
      { label: 'Toleranzband', className: 'text-3xl text-landing-primary' },
      { label: 'Diskussion', className: 'text-2xl text-landing-status-emerald' },
      { label: 'Q&A', className: 'text-4xl text-landing-fg' },
      { label: 'Plausibilität', className: 'text-xl text-landing-status-amber' },
      { label: 'Kontroverse', className: 'text-2xl text-landing-status-rose' },
      { label: 'Peer Instruction', className: 'text-lg text-landing-fg-muted' },
      { label: 'Moderation', className: 'text-3xl text-landing-tertiary' },
      { label: 'Klärungsbedarf', className: 'text-xl text-landing-status-violet' },
    ],
    nextStep:
