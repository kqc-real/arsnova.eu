...
const EN_LABELS: SessionResultsReportLabels = {
  ...
  confidenceRisk: 'Responses with misconception hint',
  ...
  confidenceReadingGuideRisk:
    'Misconception-hint response = incorrect answer + high self-assessment (4–5)',
  ...
  confidenceNotSupportedForQuestion: 'Self-assessment is not offered for the question type “{0}”.',
  confidenceDisabledForQuestion: 'You disabled self-assessment for this question in this quiz.',
  ...
  lowSuccessRateHintTemplate:
    'Only {0} answered correctly in this session. Check wording, prior knowledge, and time limit.',
  ...
  confidenceRiskCol: 'Misconception hint',
  ...
  finalSummaryRiskTemplate: '{0} of responses with misconception hint',
  finalSummaryTopTeamTemplate: '{0} achieved the highest team score',
  nextStepsDebriefFirstTemplate: 'Debrief question {0} first (misconception hint)',
  ...
  coverSummaryRisk: 'Questions with misconception hint',
  coverSummaryRiskNote:
    'A question counts when at least 2 people and at least 10% answered incorrectly with high confidence.',
  ...
  heatmapLegendToneRisk: '⚠ Misconception hint: incorrect with high self-assessment',
  ...
  heatmapCompactLegend: '✓ Solid · ⚠ Hint · ? Fragile · ◯ Knowledge gap · M Medium',
  ...
  actionPlanDebrief: 'Clarify possible misconception first',
  ...
  actionPlanCriteriaNote:
    'Automatically prioritized by misconception hint, success rate, and confidence.',
  ...
  strongestDistractor: 'Strongest distractor (most common incorrect answer)',
