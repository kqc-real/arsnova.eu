...
const EN_LABELS: SessionResultsReportLabels = {
  ...
  structuredOrderingMatrixTitle: 'Selected positions',
  structuredMatchingMatrixTitle: 'Selected matches',
  structuredCategorizationMatrixTitle: 'Selected categories',
  structuredMatrixItemHeader: 'Item',
  structuredMatrixCorrectCell: 'Answer key',
