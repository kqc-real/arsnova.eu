...
const EN_LABELS: SessionResultsReportLabels = {
  ...
  coverSubtitle: 'Student understanding, misconceptions, and a debriefing plan',
  quizName: 'Quiz',
  ...
  confidenceRisk: 'Responses with misconception pattern',
  ...
  confidenceReadingGuideRisk:
    'Misconception-pattern response = incorrect answer + high self-assessment (4–5)',
  ...
  lowSuccessRateHintTemplate: '{0} correct — unusually difficult; a short recap could help.',
  ...
  confidenceRiskCol: 'Misconception pattern',
  ...
  coverSummaryRisk: 'Questions with misconception pattern',
  ...
  heatmapLegendToneRisk: '⚠ Misconception pattern: incorrect with high self-assessment',
  ...
  unusedDistractorTemplate:
    'Incorrect option “{0}” was not chosen in this session — it may be too obvious.',
