...
export const FR_LABEL_OVERRIDES: Partial<SessionResultsReportLabels> = {
  ...
  finalSummaryMasteryTemplate: '{0} % de connaissances consolidées',
  finalSummaryRiskTemplate: '{0} % de risque d’idée fausse',
...
export const ES_LABEL_OVERRIDES: Partial<SessionResultsReportLabels> = {
  ...
  finalSummaryMasteryTemplate: '{0} % de conocimiento consolidado',
  finalSummaryRiskTemplate: '{0} % de riesgo de concepto erróneo',
...
export const IT_LABEL_OVERRIDES: Partial<SessionResultsReportLabels> = {
  ...
  finalSummaryMasteryTemplate: '{0} % di conoscenza consolidata',
  finalSummaryRiskTemplate: '{0} % di rischio di errore concettuale',
