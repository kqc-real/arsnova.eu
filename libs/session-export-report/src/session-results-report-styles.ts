...
.report-cover-summary-item .report-strong {
  display: block;
  font-size: 18pt;
  line-height: 1.1;
...
.report-cover-summary-item--risk .report-strong {
...
.report-action-plan-row,
.report-hardest-item {
  margin-bottom: 0.35rem;
}

.report-action-plan-list,
.report-hardest-list {
  display: grid;
  gap: 0.35rem;
}
...
.report-distractor-analysis h3,
.report-pi-gain h3,
.report-response-time h3 {
  margin: 0 0 0.35rem;
  font-size: 10.5pt;
  color: var(--report-brand);
}
...
.report-metric--success strong, .report-metric--success .report-strong { color: var(--report-success); }
.report-metric--risk strong, .report-metric--risk .report-strong { color: var(--report-danger); }
.report-metric--fragile strong, .report-metric--fragile .report-strong { color: #1565c0; }
.report-metric--gap strong, .report-metric--gap .report-strong { color: var(--report-warning); }
.report-metric--middle strong, .report-metric--middle .report-strong { color: var(--report-muted); }
...
.report-top-signal .report-strong {
  display: block;
  margin-bottom: 0.15rem;
  color: #7a1634;
}
...
.report-chart-block .report-chart-title {
  break-after: avoid;
  page-break-after: avoid;
}
...
.report-meta-item .report-strong {
  font-weight: 600;
  color: var(--report-ink);
}
...
.report-question-body h3:first-child {
  margin-top: 0;
}
...
.report-structured-solution {
  margin: 0.55rem 0 0.75rem;
  padding: 0.65rem 0.75rem 0.75rem;
  border: 1px solid color-mix(in srgb, var(--report-success) 35%, var(--report-line));
  border-left: 4px solid var(--report-success);
  border-radius: 0.65rem;
  background: linear-gradient(
    180deg,
    var(--report-success-soft) 0%,
    #fff 42%
  );
  break-inside: avoid;
  page-break-inside: avoid;
...
.report-structured-solution-header {
  display: flex;
  align-items: center;
  gap: 0.45rem;
  margin: 0 0 0.55rem;
...
.report-structured-solution-header h3 {
  margin: 0;
  font-size: 10.5pt;
  font-weight: 700;
  color: var(--report-success);
...
.report-structured-solution-badge {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  flex: 0 0 auto;
...
.report-structured-steps,
.report-structured-pairs {
  list-style: none;
  margin: 0;
  padding: 0;
  display: flex;
...
.report-structured-step,
.report-structured-pair {
  display: grid;
  align-items: start;
  gap: 0.55rem;
...
.report-structured-step-text,
.report-structured-pair-left,
.report-structured-pair-right {
  min-width: 0;
  font-size: 9.5pt;
  line-height: 1.35;
  color: var(--report-ink);
...
.report-structured-pair-arrow {
  color: var(--report-success);
  font-weight: 700;
}

.report-structured-category-grid {
  display: grid;
  grid-template-columns: repeat(auto-fit, minmax(11rem, 1fr));
  gap: 0.45rem;
}

.report-structured-category-card {
  margin: 0;
...
.report-structured-category-card h4 {
  margin: 0 0 0.35rem;
  padding-bottom: 0.25rem;
  border-bottom: 1px solid color-mix(in srgb, var(--report-success) 22%, var(--report-line));
  font-size: 9.5pt;
  font-weight: 700;
  color: var(--report-success);
}

.report-structured-category-items {
  list-style: none;
  margin: 0;
  padding: 0;
  display: flex;
...
.report-structured-category-items li {
  display: flex;
...
.report-structured-category-dot {
  flex: 0 0 auto;
  width: 0.4rem;
  height: 0.4rem;
  margin-top: 0.35rem;
...
.report-structured-insights--warn {
  border-color: color-mix(in srgb, #8d1b3d 28%, var(--report-line));
  background: #fff7f9;
}

.report-structured-insights h4 {
  margin: 0 0 0.35rem;
  font-size: 9pt;
  font-weight: 700;
  color: var(--report-muted);
...
.report-structured-chip-label {
  min-width: 0;
}

.report-structured-hit-rates {
  list-style: none;
  margin: 0;
  padding: 0;
  display: flex;
...
.report-structured-hit-rate-copy {
  display: flex;
...
.report-structured-hit-rate-copy strong {
  flex: 0 0 auto;
  color: var(--report-brand, #002395);
  font-variant-numeric: tabular-nums;
}

.report-structured-hit-rate-track {
  height: 0.35rem;
  border-radius: 999px;
  background: color-mix(in srgb, var(--report-line) 80%, #fff);
  overflow: hidden;
}

.report-structured-hit-rate-fill {
  height: 100%;
...
.report-confidence-card .report-strong {
  display: block;
  font-size: 11pt;
}
...
.report-heatmap-row {
  display: grid;
  grid-template-columns: minmax(5.5rem, 1.2fr) repeat(3, minmax(3.5rem, 1fr));
  gap: 0.25rem;
  align-items: center;
}
...
.report-heatmap-row-label {
  font-weight: 650;
  font-size: 9pt;
  padding-left: 0.15rem;
}

.report-heatmap .report-heat {
  border: 1px solid var(--report-line);
  border-radius: 0.35rem;
...
.report-confidence-category-list .report-strong {
  font-variant-numeric: tabular-nums;
}
...
.report-numeric-primary .report-strong {
  font-weight: 700;
}

.report-chart-block--secondary > .report-chart-title {
  font-size: 9.5pt;
  font-weight: 600;
  color: var(--report-muted);
}
...
/**
 * Chromium-getaggte PDFs: dekorative Paint-Ops (Balken, SVG, Borders ohne Text)
 * landen untagged (veraPDF 7.1/3). Für den PDF-Export neutralisieren.
 */
export const SESSION_RESULTS_REPORT_PDF_UA_SAFE_STYLES = `
html.report-pdf-ua [aria-hidden="true"] {
  display: none !important;
}
html.report-pdf-ua .report-cover-logo,
html.report-pdf-ua svg,
html.report-pdf-ua .report-hist-bar,
html.report-pdf-ua .report-vbar-fill,
html.report-pdf-ua .report-peer-change-bar,
html.report-pdf-ua .report-peer-change-swatch {
  display: none !important;
}
html.report-pdf-ua * {
...
html.report-pdf-ua .report-bar-fill,
html.report-pdf-ua .report-vbar-fill,
html.report-pdf-ua .report-hist-bar,
html.report-pdf-ua .report-hist-bar-wrap {
...
html.report-pdf-ua .report-bar-track,
html.report-pdf-ua .report-vbar-track,
html.report-pdf-ua .report-hist-bar-wrap {
  height: auto !important;
  min-height: 0 !important;
  border: none !important;
...
html.report-pdf-ua .report-bar-pct {
  color: inherit !important;
  font-weight: 650;
}
html.report-pdf-ua table,
html.report-pdf-ua th,
html.report-pdf-ua td {
  border: 1px solid #999 !important;
  background: none !important;
}
/* Dekorative Symbole sind display:none → ohne Anpassung läuft Label in 1.25rem-Spalte. */
html.report-pdf-ua .report-confidence-category-list li {
  grid-template-columns: 1fr auto;
  align-items: start;
  column-gap: 0.75rem;
  row-gap: 0.15rem;
}
html.report-pdf-ua .report-confidence-category-list li > span:not(.report-heat-symbol) {
  min-width: 0;
  line-height: 1.35;
}
html.report-pdf-ua .report-confidence-category-list strong,
html.report-pdf-ua .report-confidence-category-list .report-strong {
  justify-self: end;
  white-space: nowrap;
}
html.report-pdf-ua .report-heat-cell {
